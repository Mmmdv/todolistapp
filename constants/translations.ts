export const TRANSLATIONS = {
    az: {
        ...
        home_movies_desc: "İzləniləcəklər siyahısı",
        home_birthdays_desc: "Özəl günləri unutma",
        home_shopping_desc: "Alış-veriş siyahısı",
        home_events_desc: "Tədbirləri idarə et",
        home_expenses_desc: "Xərcləri izlə",
    ...
    en: {
        ...
        home_movies_desc: "Watchlist",
        home_birthdays_desc: "Don't forget special days",
        home_shopping_desc: "Shopping list",
        home_events_desc: "Manage events",
        home_expenses_desc: "Track expenses",
    ...
    ru: {
        ...
        home_movies_desc: "Список к просмотру",
        home_birthdays_desc: "Не забывай про праздники",
        home_shopping_desc: "Список покупок",
        home_events_desc: "Управление событиями",
        home_expenses_desc: "Учет расходов",
